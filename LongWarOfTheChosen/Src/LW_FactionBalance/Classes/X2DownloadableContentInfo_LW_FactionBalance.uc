...
static function bool AbilityTagExpandHandler(string InString, out string OutString)
{
	...
	case 'KnifeJugglerBonusDamage':
		OutString = string(class'X2Ability_ReaperAbilitySet_LW'.default.KNIFE_JUGGLER_BONUS_DAMAGE);
		return true;
	case 'KnifeJugglerExtraAmmo':
		OutString = string(class'X2Ability_ReaperAbilitySet_LW'.default.KNIFE_JUGGLER_EXTRA_AMMO);
		return true;
