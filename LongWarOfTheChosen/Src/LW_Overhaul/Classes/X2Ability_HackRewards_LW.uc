...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(BuildStatModifyingAbility('ADVENTFirewalls',		"img:///UILibrary_PerkIcons.UIPerk_hack_reward_debuff", EETS_AllRoboticEnemies, 33,											ePerkBuff_Passive, eStat_HackDefense,	default.FIREWALLS_HACKDEFENSE_BONUS));
