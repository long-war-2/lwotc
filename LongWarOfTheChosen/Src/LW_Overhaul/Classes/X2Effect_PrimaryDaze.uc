class X2Effect_PrimaryDaze extends X2Effect_Persistent;
...
function RegisterForEvents(XComGameState_Effect EffectGameState)
{
	...
	EventMgr.RegisterForEvent(EffectObj, 'AbilityActivated', class'X2Ability_LW_ChosenAbilities'.static.AbilityTriggerEventListener_PrimaryDaze, ELD_OnStateSubmitted, 40, SourceUnitState);
}

DefaultProperties
{
	EffectName="PrimaryDazeEffect"
