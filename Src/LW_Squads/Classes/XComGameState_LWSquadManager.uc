...
// WOTC TODO: We'll need to add the l10n files for squad management to get these to work.
...
static function CreateSquadManager(optional XComGameState StartState)
{
	...
	if(StartState != none)
	{
		SquadMgr = XComGameState_LWSquadManager(StartState.CreateStateObject(class'XComGameState_LWSquadManager'));
	...
	else
	{
		...
		SquadMgr = XComGameState_LWSquadManager(NewGameState.CreateStateObject(class'XComGameState_LWSquadManager'));
...
static function CreateFirstMissionSquad(XComGameState StartState)
{
	...
	NewSquad = XComGameState_LWPersistentSquad(StartState.CreateStateObject(class'XComGameState_LWPersistentSquad'));
...
function EventListenerReturn ConfigureSquadOnEnterSquadSelect(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID, Object CallbackData)
{
	...
	`Log("ConfigureSquadOnEnterSquadSelect : Starting listener.");
	...
	`Log("ConfigureSquadOnEnterSquadSelect : Parsed XComHQ.");
	...
	`Log("ConfigureSquadOnEnterSquadSelect : RetrievedSquadSelect.");
