...
function Initialize()
{
	...
	// WOTC TODO: Restore when alien activities are back.
...
function int GetQueueOffsetModifier()
{
	...
	/* WOTC TODO: Restore when squad management is back
...
function bool CanAddToBucket()
{
	...
	local XComGameState_MissionSite MissionState;
	// WOTC TODO: Restore when strategy AI is back
...
function int CheckForReinforcements()
{
	...
	if (CanAddToBucket())
	{
		// WOTC TODO: Restore when strategy AI is back in
